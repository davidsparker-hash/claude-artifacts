...
function EditBay({ state, cat, subIdx, flashId, theme, onCat, onSub, onMode, messageRail }) {
  ...
  return (
    <div style={{ flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column', background: DK.bg0 }}>
      {/* monitors row — message rail rides here, in the upper region only */}
      <div style={{ flex: '1 1 auto', display: 'flex', minHeight: 0 }}>
        {messageRail && (
          <div style={{ flex: '0 0 340px', minWidth: 0, minHeight: 0, borderRight: `1px solid ${DK.line}`, background: DK.bg1, display: 'flex', flexDirection: 'column' }}>
            {messageRail}
          </div>
        )}
...
Object.assign(window, { EditBay, DK_DARK, DK_LIGHT });
