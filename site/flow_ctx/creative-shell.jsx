...
function CreativeLane(props) {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0, background: ck.bg0, display: 'flex', flexDirection: 'column' }}>
      ...
      {/* ── Body: persistent Message·Producer rail + tab content ── */}
      <div style={{ flex: 1, minHeight: 0, display: 'flex' }}>
        ...
        <div style={{ flex: 1, minWidth: 0, minHeight: 0, display: 'flex', flexDirection: 'column' }}>
          {tab === 'bay' ? (
            EditBay ? <EditBay state={state} cat={cat} subIdx={subIdx} flashId={flashId} theme={theme} onCat={onCat} onSub={onSub} onMode={onMode} /> : null
          ) : tab === 'writers' ? (
